    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center group">
          <div className="text-white font-bold text-xl relative overflow-hidden transition-all duration-300 group-hover:scale-105 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-cyan-400 group-hover:to-blue-500">
            {personalInfo.name}
            <span className="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-cyan-400 to-blue-500 transition-all duration-300 group-hover:w-full"></span>
          </div>
          <span className="text-white/80 text-sm ml-2 hidden sm:inline-block transition-all duration-300 group-hover:text-white">
            / {personalInfo.title}
          </span>
        </Link>
          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className="absolute inset-0 bg-cyan-500/0 rounded-md group-hover:bg-cyan-500/20 transition-all duration-300"></span>
        ...
        {/* Mobile Menu Button */}
        <button
          className="md:hidden text-white hover:text-cyan-100 transition-colors duration-300 relative overflow-hidden group"
            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive ? "text-white font-medium border-cyan-400/30" : "text-white/80 hover:text-white hover:pl-5",
                )}
